...
public class BuyDetailAdapter  extends ArrayAdapter<CostInfo> {
        private Activity contexts;
        private List<CostInfo> lists;

        BuyDetailAdapter(Activity context, List<CostInfo> list) {
            super(context, R.layout.buy_item_details, list);
        ...
        public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
            ...
            if (listItemView == null) {
                listItemView = LayoutInflater.from(getContext()).inflate(
                        R.layout.buy_item_details, parent, false);
            }
